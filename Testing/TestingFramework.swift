...
import SwiftUI
    ...
    public struct PerformanceMetrics {
        ...
        public var standardDeviation: TimeInterval {
            ...
            let variance = executionTimes
                .map { pow($0 - mean, 2) }
                .reduce(0, +) / Double(executionTimes.count - 1)

            return sqrt(variance)
        }

        public var successRate: Double {
            let successCount = iterations - errors.count
    ...
    public struct MemoryMetrics {
        ...
        public var memoryDeltaMB: Double {
            Double(memoryDelta) / 1024.0 / 1024.0
        }
    }
    ...
    public struct TestConfiguration {
        ...
        private init() {
            ...
            isPerformanceTesting = ProcessInfo.processInfo.arguments.contains("--performance")
            testTimeout = 10.0
            maxRetryCount = 3
        }
    }
    ...
    public class TestReporter {
        ...
        public func generateReport() -> TestReport {
            ...
            let skippedTests = testResults.filter { $0.status == .skipped }
