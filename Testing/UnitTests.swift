    ...
    class HabitManagerTests: BaseTestCase {
        ...
        func testCompleteHabitIncreasesStreak() async throws {
            ...
            let trackCalls = mockAnalytics.callHistory.filter { $0.contains("track") }
        ...
        func testGetHabitsByFrequency() async throws {
            ...
            mockDataService.setReturnValue(habits, for: "load")
        ...
        func testDeleteHabit() async throws {
            ...
            // When
            try await habitManager.deleteHabit(habitId: habit.id)

            // Then
            XCTAssertTrue(mockDataService.wasMethodCalled("delete"))
            XCTAssertTrue(mockAnalytics.wasMethodCalled("track"))
        }
    ...
    class FinancialAccountManagerTests: BaseTestCase {
        ...
        override func setUp() {
            ...
            mockDataService = MockDataService()
            mockAnalytics = MockAnalyticsService()
            accountManager = FinancialAccountManager(
                dataService: mockDataService,
                analyticsService: mockAnalytics
            )
        }
        ...
        func testTransferFunds() async throws {
            ...
            mockDataService.setReturnValue(fromAccount, for: "load")
            mockDataService.setReturnValue(toAccount, for: "load")
        ...
        func testGetAccountsByType() async throws {
            ...
            mockDataService.setReturnValue(accounts, for: "load")
    ...
    class TaskManagerTests: BaseTestCase {
        ...
        func testGetTasksByPriority() async throws {
            ...
            mockDataService.setReturnValue(tasks, for: "load")
    ...
    class HabitManager {
        ...
        func createHabit(name: String, frequency: HabitFrequency) async throws -> Habit {
            ...
            await analyticsService.track(event: "habit_created", properties: ["name": name])
        ...
        func completeHabit(habitId: UUID) async throws -> Habit {
            ...
            try await dataService.save(habit, with: habitId.uuidString)
            await analyticsService.track(event: "habit_completed", properties: ["habitId": habitId.uuidString])
        ...
        func deleteHabit(habitId: UUID) async throws {
            try await dataService.delete(with: habitId.uuidString)
            await analyticsService.track(event: "habit_deleted", properties: ["habitId": habitId.uuidString])
        }
        ...
        func resetStreak(habitId: UUID) async throws -> Habit {
            ...
            try await dataService.save(habit, with: habitId.uuidString)
            await analyticsService.track(event: "habit_streak_reset", properties: ["habitId": habitId.uuidString])
    ...
    class FinancialAccountManager {
        ...
        func createAccount(name: String, balance: Double, type: AccountType) async throws -> FinancialAccount {
            ...
            await analyticsService.track(event: "account_created", properties: ["type": type.rawValue])
        ...
        func updateBalance(accountId: UUID, newBalance: Double) async throws -> FinancialAccount {
            ...
            try await dataService.save(account, with: accountId.uuidString)
            return account
        }
        ...
        func transferFunds(from fromAccountId: UUID, to toAccountId: UUID, amount: Double) async throws {
            guard let fromAccount = try await dataService.load(FinancialAccount.self, with: fromAccountId.uuidString),
                  let toAccount = try await dataService.load(FinancialAccount.self, with: toAccountId.uuidString)
            else {
                throw TestError.mockNotConfigured
            }
            ...
            try await dataService.save(updatedFromAccount, with: fromAccountId.uuidString)
            try await dataService.save(updatedToAccount, with: toAccountId.uuidString)

            await analyticsService.track(event: "funds_transferred", properties: ["amount": amount])
        }
    ...
    class TaskManager {
        ...
        func createTask(title: String, description: String?, priority: TaskPriority) async throws -> Task {
            ...
            await analyticsService.track(event: "task_created", properties: ["priority": priority.rawValue])
        ...
        func completeTask(taskId: UUID) async throws -> Task {
            ...
            try await dataService.save(task, with: taskId.uuidString)
            await analyticsService.track(event: "task_completed", properties: ["taskId": taskId.uuidString])
        ...
        func deleteTask(taskId: UUID) async throws {
            try await dataService.delete(with: taskId.uuidString)
            await analyticsService.track(event: "task_deleted", properties: ["taskId": taskId.uuidString])
        }
    }
