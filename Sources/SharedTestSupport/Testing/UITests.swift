    ...
    class HabitQuestUITests: UITestCase {
        func testHabitCreationFlow() throws {
            ...
            let habitCell = app.cells.containing(.staticText, identifier: "Morning Exercise")
                .firstMatch
    ...
    class MomentumFinanceUITests: UITestCase {
        ...
        func testTransactionFlow() throws {
            ...
            let transactionItem = app.cells.containing(.staticText, identifier: "Grocery shopping")
                .firstMatch
    ...
    class PlannerAppUITests: UITestCase {
        func testTaskCreationFlow() throws {
            ...
            typeAndWait(
                "Prepare slides and practice presentation for quarterly review",
                in: descriptionField)
            ...
            let taskCell = app.cells.containing(
                .staticText, identifier: "Complete project presentation"
            ).firstMatch
