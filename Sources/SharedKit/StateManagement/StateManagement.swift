...
import SharedKitCore
    ...
    public class MockFinancialService: SharedKitCore.FinancialServiceProtocol {
        ...
        public func initialize() async throws {}
        public func cleanup() async {}
        public func healthCheck() async -> SharedKitCore.ServiceHealthStatus {
            .healthy
        }
        ...
        public func calculateAccountBalance(_ accountId: UUID, asOf: Date?) async throws -> Double {
            0
        }
