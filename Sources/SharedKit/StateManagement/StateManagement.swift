...
import SharedKitCore
    ...
    // Note: StateValue, StateChangeType, and ProjectType are now
        ...
        StateSynchronizable
    {
        ...
        @Injected public var habitService: any HabitServiceProtocol
        @Injected public var analyticsService: any AnalyticsServiceProtocol
