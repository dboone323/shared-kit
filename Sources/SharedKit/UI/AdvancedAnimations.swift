                ...
                content
                    .offset(
                        ...
                        y: self.edge == .top || self.edge == .bottom
                            ? (self.isPresented ? 0 : (self.edge == .top ? -self.offset : self.offset))
                            : 0
                    )
        ...
        public extension View {
            ...
            func pulse(scale: CGFloat = 1.1, opacity: Double = 0.6, duration: Double = 1.0)
                -> some View
            {
            ...
            func slideTransition(isPresented: Bool, from edge: Edge, offset: CGFloat = 300)
                -> some View
            {
