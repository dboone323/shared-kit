...
public actor QuantumSafeSecurity {
    private let logger = os.Logger(
        subsystem: "com.quantum.workspace", category: "QuantumSafeSecurity")
    ...
    private let complianceManager: QuantumSafeComplianceManager

    // Security state
    private var securityMetrics: QuantumSafeSecurityMetrics
    private var activeThreats: [QuantumSafeSecurityThreat] = []
    private var securityPolicies: [QuantumSafeSecurityPolicy] = []
    ...
    public init() {
        ...
        self.threatDetector = QuantumSafeThreatDetector()  // Prefixed with QuantumSafe
        self.complianceManager = QuantumSafeComplianceManager()

        self.securityMetrics = QuantumSafeSecurityMetrics(
    ...
    public func generateKeyPair(
        algorithm: QuantumSafeAlgorithm = .kyber,
        keySize: QuantumSafeKeySize = .keySize256
    ...
    public func assessSecurityPosture() async throws -> QuantumSafeSecurityAssessment {
        ...
        let assessment = QuantumSafeSecurityAssessment(
    ...
    public func detectQuantumThreats() async throws -> [QuantumSafeSecurityThreat] {
    ...
    public func getSecurityMetrics() -> QuantumSafeSecurityMetrics {
        securityMetrics
    }

    /// Get active security policies
    public func getSecurityPolicies() -> [QuantumSafeSecurityPolicy] {
        securityPolicies
    }
    ...
    private func respondToThreat(_ threat: QuantumSafeSecurityThreat) async throws {
    ...
    private func generateSecurityRecommendations(
        ...
        _ key: QuantumSafeKeyHealthAssessment,
        _ threat: QuantumSafeThreatAssessment,
        _ compliance: QuantumSafeComplianceAssessment
    ) -> [QuantumSafeSecurityRecommendation] {
        var recommendations: [QuantumSafeSecurityRecommendation] = []
...
public actor QuantumSafeCryptoManager {
    private let logger = os.Logger(
        subsystem: "com.quantum.workspace", category: "QuantumSafeCrypto")
    ...
    public func initialize() async throws {
        ...
        activeAlgorithms[.kyber] = QuantumSafeAlgorithmState(
            algorithm: .kyber,
            isActive: true,
            performanceMetrics: QuantumSafeAlgorithmPerformance(
    ...
    public func assessCryptographicStrength() async throws -> CryptographicAssessment {
        ...
        for (algorithm, state) in activeAlgorithms {
            let score =
                ...
                ? 1.0
                : state.performanceMetrics.securityLevel.rawValue >= 3 ? 0.8 : 0.6

            totalScore += score

            algorithmAssessments.append(
                QuantumSafeAlgorithmAssessment(
                    algorithm: algorithm,
...
public actor QuantumSafeKeyManager {
    ...
    private var keyMetadata: [String: QuantumSafeKeyMetadata] = [:]
    ...
    public func initializeKeys() async throws {
        ...
        for algorithm in algorithms {
            ...
            keyMetadata[keyPair.id] = QuantumSafeKeyMetadata(
                keyId: keyPair.id,
                algorithm: algorithm,
                creationDate: Date(),
                lastRotation: Date(),
    ...
    public func rotateKeys() async throws {
        ...
        for (keyId, _) in keyStore {
            ...
            keyMetadata[newKeyPair.id] = QuantumSafeKeyMetadata(
                keyId: newKeyPair.id,
                algorithm: .kyber,
                creationDate: Date(),
                lastRotation: Date(),
    ...
    /// Assess key health
    public func assessKeyHealth() async throws -> QuantumSafeKeyHealthAssessment {
        ...
        return QuantumSafeKeyHealthAssessment(
            overallScore: overallScore,
            totalKeys: totalKeys,
...
public actor QuantumSafeProtocolManager {
    private let logger = os.Logger(
        subsystem: "com.quantum.workspace", category: "QuantumSafeProtocol")

    private var activeChannels: [String: QuantumSafeChannel] = [:]
    private var protocolConfigurations: [String: QuantumSafeProtocolConfiguration] = [:]
    ...
    public func initializeProtocols() async throws {
        ...
        protocolConfigurations["kyber-kem"] = QuantumSafeProtocolConfiguration(
        ...
        protocolConfigurations["dilithium-sig"] = QuantumSafeProtocolConfiguration(
...
public actor QuantumSafeThreatDetector {
    private let logger = os.Logger(
        subsystem: "com.quantum.workspace", category: "QuantumSafeThreatDetector"
    )

    private var monitoringActive = false
    private var threatPatterns: [QuantumSafeThreatPattern] = []
    ...
    public func assessThreatLandscape() async throws -> QuantumSafeThreatAssessment {
        ...
        return QuantumSafeThreatAssessment(
...
public actor QuantumSafeComplianceManager {
    private let logger = os.Logger(
        subsystem: "com.quantum.workspace", category: "SecurityCompliance")

    private var complianceStandards: [QuantumSafeComplianceStandard] = []

    /// Initialize compliance management
    public func initializeCompliance() async throws {
        complianceStandards = [
            QuantumSafeComplianceStandard(
    ...
    /// Assess compliance
    public func assessCompliance() async throws -> QuantumSafeComplianceAssessment {
        var compliantStandards = 0
        let totalStandards = complianceStandards.count
        ...
        return QuantumSafeComplianceAssessment(
...
/// Key size
public enum QuantumSafeKeySize: Int, Sendable {
    case keySize256 = 256
    case keySize512 = 512
...
/// Security level
public enum QuantumSafeSecurityLevel: Int, Sendable {
    case level1 = 1
...
/// Security metrics
public struct QuantumSafeSecurityMetrics: Sendable {
...
/// Security assessment
public struct QuantumSafeSecurityAssessment: Sendable {
    public let overallScore: Double
    public let cryptographicStrength: CryptographicAssessment
    public let keyHealth: QuantumSafeKeyHealthAssessment
    public let threatLandscape: QuantumSafeThreatAssessment
    public let complianceStatus: QuantumSafeComplianceAssessment
    public let recommendations: [QuantumSafeSecurityRecommendation]
...
public struct CryptographicAssessment: Sendable {
    public let overallScore: Double
    public let algorithmAssessments: [QuantumSafeAlgorithmAssessment]
...
public struct QuantumSafeAlgorithmAssessment: Sendable {
    public let algorithm: QuantumSafeAlgorithm
    public let securityLevel: QuantumSafeSecurityLevel
...
public struct QuantumSafeAlgorithmPerformance: Sendable {
...
public struct QuantumSafeAlgorithmState: Sendable {
    public let algorithm: QuantumSafeAlgorithm
    public let isActive: Bool
    public let performanceMetrics: QuantumSafeAlgorithmPerformance
}

/// Key health assessment
public struct QuantumSafeKeyHealthAssessment: Sendable {
    public let overallScore: Double
...
/// Key metadata
public struct QuantumSafeKeyMetadata: Sendable {
    public let keyId: String
    public let algorithm: QuantumSafeAlgorithm
    public let creationDate: Date
...
/// Threat assessment
public struct QuantumSafeThreatAssessment: Sendable {
    public let overallScore: Double
    public let activeThreats: Int
    public let criticalThreats: Int
    public let highThreats: Int
    public let threatPatterns: [QuantumSafeThreatPattern]
    public let assessmentDate: Date
...
/// Threat pattern
public struct QuantumSafeThreatPattern: Sendable {
    public let type: QuantumSafeThreatType
    public let signature: String
    public let severity: QuantumSafeThreatSeverity
    public var detectionConfidence: Double
}

/// Security threat
public struct QuantumSafeSecurityThreat: Sendable {
    public let id: String
    public let type: QuantumSafeThreatType
    public let severity: QuantumSafeThreatSeverity
...
/// Threat type
public enum QuantumSafeThreatType: String, Sendable {
    case quantumAttack, keyCompromise, protocolWeakness, complianceViolation
}

/// Threat severity
public enum QuantumSafeThreatSeverity: String, Sendable {
    case low, medium, high, critical
}

/// Compliance assessment
public struct QuantumSafeComplianceAssessment: Sendable {
    public let overallScore: Double
    public let compliantStandards: Int
    public let totalStandards: Int
    public let violations: [QuantumSafeComplianceStandard]
    public let assessmentDate: Date
...
/// Compliance standard
public struct QuantumSafeComplianceStandard: Sendable {
    public let name: String
    public let requirements: [QuantumSafeSecurityRequirement]
    public let status: QuantumSafeComplianceStatus
}

/// Compliance status
public enum QuantumSafeComplianceStatus: String, Sendable {
    case compliant, nonCompliant, partial
}

/// Security requirement
public enum QuantumSafeSecurityRequirement: Sendable {
    case algorithm(QuantumSafeAlgorithm)
    case keySize(QuantumSafeKeySize)
    case securityLevel(QuantumSafeSecurityLevel)
    case maxKeyAge(TimeInterval)
    case threatDetection(QuantumSafeThreatType)
}

/// Security policy
public struct QuantumSafeSecurityPolicy: Sendable {
    public let id: String
    public let name: String
    public let description: String
    public let requirements: [QuantumSafeSecurityRequirement]
    public let enforcement: QuantumSafePolicyEnforcement
}

/// Policy enforcement level
public enum QuantumSafePolicyEnforcement: String, Sendable {
    case lenient, moderate, strict
}

/// Security recommendation
public struct QuantumSafeSecurityRecommendation: Sendable {
    public let priority: QuantumSafeRecommendationPriority
...
public enum QuantumSafeRecommendationPriority: String, Sendable {
    case low, medium, high, critical
}

/// Protocol configuration
public struct QuantumSafeProtocolConfiguration: Sendable {
    public let name: String
    public let algorithm: QuantumSafeAlgorithm
    public let keySize: QuantumSafeKeySize
    public let securityLevel: QuantumSafeSecurityLevel
    public var isActive: Bool
}
...
@MainActor
public func performSecurityAssessment() async throws -> QuantumSafeSecurityAssessment {
    let security = QuantumSafeSecurity()
    try await security.initializeSecurity()
