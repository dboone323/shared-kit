...
public struct AgentCapability: Sendable {
    ...
    public func canHandle(_ taskType: MASTaskType) -> Bool {
...
public struct AgentTask: Sendable {
    ...
    public let type: MASTaskType
    public let priority: MASTaskPriority
    ...
    public init(
        ...
        description: String,
        type: MASTaskType,
        priority: MASTaskPriority = .medium,
...
/// Task type
public enum MASTaskType: Sendable {
    case computation, communication, learning, coordination
    case specialized(String)
}

/// Task priority
public enum MASTaskPriority: String, Sendable {
...
public enum MultiAgentError: Error {
    case noCapableAgents(MASTaskType)
