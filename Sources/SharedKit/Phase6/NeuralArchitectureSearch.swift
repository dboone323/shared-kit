...
public actor ArchitectureEvaluator {
    ...
    private func getOptimalParameterCount(_ taskType: NASTaskType) -> Int {
        switch taskType {
...
public struct NeuralArchitecture: Sendable {
    ...
    public let taskType: NASTaskType
...
/// Task types for architecture search
public enum NASTaskType: String, Sendable {
...
public struct MLTask: Sendable {
    ...
    public init(
        name: String, type: NASTaskType, complexity: ComplexityLevel = .medium,
        inputShape: [Int] = [],
...
public struct SearchSpaceConfiguration: Sendable {
    ...
    public let supportedTasks: [NASTaskType]
}
