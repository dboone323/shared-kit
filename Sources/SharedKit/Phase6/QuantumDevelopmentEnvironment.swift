...
public actor QuantumDevelopmentEnvironment {
    ...
    public func deployQuantumApplication(
        ...
        target: QuantumDeploymentTarget
    ) async throws -> QuantumDeploymentResult {
...
public struct DebugState: Sendable {
    ...
    public let qubitStates: [Int: DevQuantumState]
    public let measurements: [Int: Int]
    public let timestamp: Date
}

/// Quantum state
public struct DevQuantumState: Sendable {
...
/// Complex number
public struct QuantumComplex: Codable, Sendable {
    ...
    public static func * (lhs: QuantumComplex, rhs: QuantumComplex) -> QuantumComplex {
        QuantumComplex(
...
/// Deployment target
public enum QuantumDeploymentTarget: String, Sendable {
    case local, cloud, hybrid
}

/// Deployment result
public struct QuantumDeploymentResult: Sendable {
    public let applicationId: String
    public let target: QuantumDeploymentTarget
