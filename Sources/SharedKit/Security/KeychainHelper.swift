...
extension KeychainHelper {
    ...
    @discardableResult
    public func migrateFromUserDefaults(key: String, userDefaults: UserDefaults = .standard) -> Bool
    {
        ...
        if let value = userDefaults.object(forKey: key) {
            ...
            if success {
                ...
                userDefaults.removeObject(forKey: key)
                print(
                    "KeychainHelper: Successfully migrated '\(key)' from UserDefaults to Keychain")
                return true
            } else {
