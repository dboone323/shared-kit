...
private struct PerformancePlatformColor {
...
private struct PerformanceScoreCard: View {
    ...
    var body: some View {
        ...
        .padding()
        .background(PerformancePlatformColor.systemBackground)
        .cornerRadius(16)
...
private struct PerformanceRing: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                .stroke(
                    PerformancePlatformColor.ringBackground,
                    lineWidth: 8
                )
            ...
            .background(
                RoundedRectangle(cornerRadius: 20)
                    .fill(
                        isSelected
                            ? Color.accentColor
                            : PerformancePlatformColor.tabBackground)
            )
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack {
                ...
                Label(
                    "System: \(String(format: "%.1f", usage.system))%",
            ...
            List {
                Section("Performance Metrics") {
                    MetricDetailRow(
                        title: "Overall Score",
                        value:
                            "\(Int(performanceMonitor.currentMetrics.overallPerformanceScore))/100",
