...
public final class SynchronizationEngine {
    ...
    private func handleNetworkStatusChange(_ status: SynchronizationNetworkStatus) async {
        switch status {
        case .connected:
...
public struct SyncOperation {
    ...
    public init(id: String = UUID().uuidString,
        ...
        self.data = (try? JSONSerialization.data(withJSONObject: data)) ?? Data()
...
public struct SyncStatus {
    ...
    public let networkStatus: SynchronizationNetworkStatus
